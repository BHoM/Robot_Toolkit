...
namespace RobotToolkit
{
    ...
    public class PropertyIO
    {
        ...
        /// <returns></returns>
        public static ShapeType GetShapeType(IRobotBarSectionShapeType sType)
        {
            switch (sType)
            {
        ...
        internal static IRobotBarSectionType GetShapeType(ShapeType type)
        {
            switch (type)
            {
        ...
        internal static ThicknessProperty GetThickness(IRobotLabel rLabel)
        {
            IRobotThicknessData data = rLabel.Data;
            ThicknessProperty thicknessProp = null;
                ...
                case IRobotThicknessType.I_TT_HOMOGENEOUS:
                    ...
                    switch (homoData.Type)
                    {
                        ...
                        case IRobotThicknessHomoType.I_THT_VARIABLE_ALONG_LINE:
                            thicknessProp = new ConstantThickness(rLabel.Name);
                ...
                case IRobotThicknessType.I_TT_ORTHOTROPIC:
                    ...
                    switch (orthoData.Type)
                    {
                        case IRobotThicknessOrthoType.I_TOT_ONE_SIDED_UNIDIR_RIBS:
                            thicknessProp = new RibbedThickness(rLabel.Name, orthoData.H, orthoData.HA, orthoData.A1, orthoData.A, orthoData.DirType == IRobotThicknessOrthoDirType.I_TODT_DIR_X ? PanelDirection.X : PanelDirection.Y);
                            break;
                        case IRobotThicknessOrthoType.I_TOT_ONE_SIDED_BIDIR_RIBS:
                            thicknessProp = new WaffleThickness(rLabel.Name, orthoData.H, orthoData.HA, orthoData.HB, orthoData.A1, orthoData.B1, orthoData.A, orthoData.B);
                            break;
                        case IRobotThicknessOrthoType.I_TOT_MATERIAL:
                            thicknessProp = new ConstantThickness(rLabel.Name, orthoData.H);
                            double n1 = orthoData.N1;
                            double n2 = orthoData.N2;
                            modifiers = thicknessProp.Modifiers;
                            modifiers[(int)ThicknessModifier.f11] = n1;
                            modifiers[(int)ThicknessModifier.f12] = Math.Sqrt(n1 + n2);
                            modifiers[(int)ThicknessModifier.f22] = n2;
                            modifiers[(int)ThicknessModifier.m11] = n1;
                            modifiers[(int)ThicknessModifier.m12] = Math.Sqrt(n1 + n2);
                            modifiers[(int)ThicknessModifier.m22] = n2;
                            modifiers[(int)ThicknessModifier.v13] = n1;
                            modifiers[(int)ThicknessModifier.v23] = n2;
                            break;
                        ...
                        default:
                            thicknessProp = new ConstantThickness(rLabel.Name, orthoData.H);
                            modifiers = thicknessProp.Modifiers;
                            modifiers[(int)ThicknessModifier.f11] = orthoData.HA;
                            modifiers[(int)ThicknessModifier.f12] = orthoData.H0;
                            modifiers[(int)ThicknessModifier.f22] = orthoData.HB;
                            modifiers[(int)ThicknessModifier.m11] = orthoData.HC;
                            modifiers[(int)ThicknessModifier.m12] = orthoData.A;
                            modifiers[(int)ThicknessModifier.m22] = orthoData.A1;
                            modifiers[(int)ThicknessModifier.v13] = orthoData.A2;
                            modifiers[(int)ThicknessModifier.v23] = orthoData.B;
                            modifiers[(int)ThicknessModifier.Weight] = orthoData.B1;
                            break;
                    }
                    break;
            }
        ...
        internal static void CreateThicknessProperty(RobotApplication robot, ThicknessProperty thicknessProperty)
        {
            ...
            if (!labelServer.IsUsed(IRobotLabelType.I_LT_PANEL_THICKNESS, thicknessProperty.Name))
            {
                ...
                if (thicknessProperty is ConstantThickness)
                {
                    if (thicknessProperty.HasModifiers())
                    {
                        ...
                        orthoData.HA = modifiers[(int)ThicknessModifier.f11];
                        orthoData.H0 = modifiers[(int)ThicknessModifier.f12];
                        orthoData.HB = modifiers[(int)ThicknessModifier.f22];
                        orthoData.HC = modifiers[(int)ThicknessModifier.m11];
                        orthoData.A = modifiers[(int)ThicknessModifier.m12];
                        orthoData.A1 = modifiers[(int)ThicknessModifier.m22];
                        orthoData.A2 = modifiers[(int)ThicknessModifier.v13];
                        orthoData.B = modifiers[(int)ThicknessModifier.v23];
                        orthoData.B1 = modifiers[(int)ThicknessModifier.Weight];
                    }
                    else
                    {
                ...
                else if (thicknessProperty is WaffleThickness)
                {
                    WaffleThickness waffle = thicknessProperty as WaffleThickness;
                    data.ThicknessType = IRobotThicknessType.I_TT_ORTHOTROPIC;
                    orthoData = data.Data;
                    orthoData.Type = (IRobotThicknessOrthoType)14;
                    orthoData.H = thicknessProperty.Thickness;
                ...
                {
                    RibbedThickness ribbed = thicknessProperty as RibbedThickness;
                    data.ThicknessType = IRobotThicknessType.I_TT_ORTHOTROPIC;
                    orthoData = data.Data;
                    orthoData.Type = (IRobotThicknessOrthoType)14;
                    orthoData.H = thicknessProperty.Thickness;
        ...
        public static BHoM.Structural.SectionProperties.SectionProperty GetSection(IRobotLabel sec_label)
        {
            ...
            if (sec_data.IsConcrete)
            {
                ...
                switch (sec_data.ShapeType)
                {
                    case IRobotBarSectionShapeType.I_BSST_CONCR_BEAM_RECT:
                        ...
                        property = SectionProperty.CreateRectangularSection(SectionType.ConcreteBeam, h, b);
                        break;
                    case IRobotBarSectionShapeType.I_BSST_CONCR_BEAM_I:
                        ...
                        property = SectionProperty.CreateISection(SectionType.ConcreteBeam, b1, b2, h, T2, T3, b, 0, 0);
                        break;
                    case IRobotBarSectionShapeType.I_BSST_CONCR_BEAM_T:
                        ...
                        property = SectionProperty.CreateTee(SectionType.ConcreteBeam, h, b, T2, b1);
                        break;
                    ...
                    case IRobotBarSectionShapeType.I_BSST_CONCR_COL_C:
                        ...
                        h = b;
                        property = SectionProperty.CreateCircularSection(SectionType.ConcreteColumn, b);
                        break;
                    case IRobotBarSectionShapeType.I_BSST_CONCR_COL_R:
                        ...
                        property = SectionProperty.CreateRectangularSection(SectionType.ConcreteColumn, h, b);
                        break;
                    case IRobotBarSectionShapeType.I_BSST_CONCR_COL_CQ:
                    ...
                    case IRobotBarSectionShapeType.I_BSST_CONCR_COL_L:
                        ...
                        property = SectionProperty.CreateAngleSection(SectionType.ConcreteColumn, h, b, h - T2, b - T1, 0, 0);
                        break;
                    ...
                    case IRobotBarSectionShapeType.I_BSST_CONCR_COL_T:
                        ...
                        T1 = concMember.GetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_L1);
                        T2 = concMember.GetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_H1);
                        property = SectionProperty.CreateTee(SectionType.ConcreteColumn, h, b, h - T2, b - 2 * T1);
            ...
            else
            {
                ...
                property = new SectionProperty(GetShapeType(sec_data.ShapeType), SectionType.Steel, d, b, Tw, Tf, r, ri, mass, s);
            }
        ...
        public static void CreateBarProperty(RobotApplication robot, SectionProperty sectionProperty)
        {
            RobotLabelServer labelServer = robot.Project.Structure.Labels;
            if (!labelServer.IsUsed(IRobotLabelType.I_LT_BAR_SECTION, sectionProperty.Name))
            {
                ...
                else if (sectionProperty.SectionMaterial == SectionType.ConcreteBeam)
                {
                    ...
                    switch (sectionProperty.Shape)
                    {
                        ...
                        case ShapeType.ISection:
                            ...
                            concreteData = data.Concrete;
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_BEAM_I_B1, sectionData[(int)SectionTableColumn.B1]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_BEAM_I_B2, sectionData[(int)SectionTableColumn.B2]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_BEAM_I_HF1, sectionData[(int)SectionTableColumn.TF1]);
                ...
                else if (sectionProperty.SectionMaterial == SectionType.ConcreteColumn)
                {
                    ...
                    switch (sectionProperty.Shape)
                    {
                        ...
                        case ShapeType.Angle:
                            ...
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_B, sectionData[(int)SectionTableColumn.Width]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_H, sectionData[(int)SectionTableColumn.Height]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_L1, sectionData[(int)SectionTableColumn.Width] - sectionData[(int)SectionTableColumn.TW]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_H1, sectionData[(int)SectionTableColumn.Height] - sectionData[(int)SectionTableColumn.TF1]);
                            break;
                        case ShapeType.Tee:
                            ...
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_B, sectionData[(int)SectionTableColumn.Width]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_H, sectionData[(int)SectionTableColumn.Height]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_L1, (sectionData[(int)SectionTableColumn.Width] - sectionData[(int)SectionTableColumn.TW]) / 2);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_H1, sectionData[(int)SectionTableColumn.Height] - sectionData[(int)SectionTableColumn.TF1]);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_L2, (sectionData[(int)SectionTableColumn.Width] - sectionData[(int)SectionTableColumn.TW]) / 2);
                            concreteData.SetValue(IRobotBarSectionConcreteDataValue.I_BSCDV_COL_H2, sectionData[(int)SectionTableColumn.Height] - sectionData[(int)SectionTableColumn.TF1]);
                            break;
                        case ShapeType.Zed:
                            break;
                    }
