...
namespace BH.Adapter.Robot
{
    public static partial class Convert
    {
        ...
        public static ISurfaceProperty FromRobot(this IRobotLabel robotLabel, Dictionary<string, IMaterialFragment> material, string robotLabelName = "")
        {
            ...
            try
            {
                if (robotLabel.Type == IRobotLabelType.I_LT_PANEL_THICKNESS)
                {
                    ...
                    return robotLabel.FromRobot(data, mat, robotLabelName);
                }
                else if (robotLabel.Type == IRobotLabelType.I_LT_CLADDING)
                {
                    ...
                    return robotLabel.FromRobot(claddData, robotLabelName);
                }
                return null;
            }
            catch (Exception)
        ...
        public static ISurfaceProperty FromRobot(this IRobotLabel robotLabel, IRobotThicknessData data, IMaterialFragment material, string robotLabelName = "")
        {
                    ...
                    case IRobotThicknessType.I_TT_HOMOGENEOUS:
                        ...
                        switch (homoData.Type)
                        {
                            case IRobotThicknessHomoType.I_THT_CONSTANT:
                                bhomProperty = new ConstantThickness { Name = robotLabelName, Thickness = homoData.ThickConst, Material = material };
                                break;
                    ...
                    case IRobotThicknessType.I_TT_ORTHOTROPIC:
                        ...
                        switch (orthoData.Type)
                        {
                            case IRobotThicknessOrthoType.I_TOT_ONE_SIDED_UNIDIR_RIBS:
                                bhomProperty = new Ribbed { Name = robotLabelName, Thickness = orthoData.H, TotalDepth = orthoData.HA, StemWidth = orthoData.A1, Spacing = orthoData.A, Direction = orthoData.DirType == IRobotThicknessOrthoDirType.I_TODT_DIR_X ? PanelDirection.X : PanelDirection.Y, Material = material };
                                break;
                            case IRobotThicknessOrthoType.I_TOT_ONE_SIDED_BIDIR_RIBS:
                                bhomProperty = new Waffle { Name = robotLabelName, Thickness = orthoData.H, TotalDepthX = orthoData.HA, TotalDepthY = orthoData.HB, StemWidthX = orthoData.A1, StemWidthY = orthoData.B1, SpacingX = orthoData.A, SpacingY = orthoData.B, Material = material };
                                break;
                            case IRobotThicknessOrthoType.I_TOT_MATERIAL:
                                bhomProperty = new ConstantThickness { Name = robotLabelName, Thickness = orthoData.H, Material = material };
                            ...
                            case IRobotThicknessOrthoType.I_TOT_USER:
                                bhomProperty = new ConstantThickness { Name = robotLabelName, Thickness = double.NaN, Material = material };
        ...
        public static ISurfaceProperty FromRobot(this IRobotLabel robotLabel, IRobotCladdingData claddData, string robotLabelName = "")
        {
