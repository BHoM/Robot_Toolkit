...
namespace BH.Adapter.Robot
{
    public static partial class Convert
    {
        ...
        public static IRobotFeLayerType ToRobot(MeshResultLayer bhomMeshLayer)
        {
        ...
        public static IRobotFeResultSmoothing ToRobot(MeshResultSmoothingType bhomPanelSmoothingType)
        {
